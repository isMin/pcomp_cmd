    ...
    public class UserFile
    {
        ...
        public bool CheckReadFile()
        {
            try
            {
                ...
                {
                    Console.WriteLine("디렉토리가 입력되지 않았습니다.");
                    return false;
                }
                ...
                {
                    Console.WriteLine("파일명이 입력되지 않았습니다.");
                    return false;
                }
                ...
                if (!di.Exists)
                {
                    Console.WriteLine("해당 디렉토리가 존재하지 않습니다.({0})", this.FilePath);
                    return false;
                }
                ...
                if (!fi.Exists)
                {
                    Console.WriteLine("해당 디렉토리에 파일이 존재하지 않습니다.({0})", this.FileFullName);
                    return false;
                }
            }
            catch (Exception e)
